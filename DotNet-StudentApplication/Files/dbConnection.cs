...
namespace StudentProcess.Files
{
    class dbConnection
    {
        ...
        public dbConnection()
        {
            try
            {
                ...
                //conn = new SqlConnection(@"Server=inthub01p-bro;Database=IntHub;User Id=svc_INTHUB; Password=kanganINTHUB");
                //conn = new SqlConnection(@"Server=SQL01D-Doc;Database=StudentHub;User Id=svc_StudentHub; Password=S95TuofOd4Ift1HtKA1U");

                conn = new SqlConnection(WebConfigurationManager.AppSettings["SQL01D-Doc"].ToString());
        ...
        public DataTable executeSelectQueryWithSP(String _query, SqlParameter[] sqlParameter)
        {
            ...
            //SqlDataAdapter myAdapterLocal = new SqlDataAdapter();
            ...
            try
            {
                ...
                //myAdapterLocal.SelectCommand = myCommand;
                //myAdapterLocal.Fill(dataTable);
                //
                //
                //myAdapterLocal.Dispose();
